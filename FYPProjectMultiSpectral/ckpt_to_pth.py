...
# Load checkpoint
checkpoint_path = r"C:\Users\isaac\Desktop\experiments\CustomModel_None_all_bands_0.5%_BigEarthNet_15epochs_3\checkpoints\last.ckpt"
...
model = CustomModel(
    ...
    model_weights=None, 
    main_path=r'C:\Users\isaac\Desktop\experiments\CustomModel_None_all_bands_0.5%_BigEarthNet_15epochs_3'
)
...
pth_path = os.path.join(save_dir, "clean_model_Custom_2.pth")
torch.save(model.state_dict(), pth_path)
print(f"Cleaned model weights saved at: {pth_path}")

# Define ONNX file path in the specified directory
onnx_path = os.path.join(save_dir, "converted_model_Custom_2.onnx")
