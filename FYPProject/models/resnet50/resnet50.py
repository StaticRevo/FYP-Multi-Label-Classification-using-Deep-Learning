...
from torchvision.models import ResNet50_Weights  # Import ResNet50_Weights for pretrained weights.
...
class BigEarthNetResNet50Model(pl.LightningModule):
    def __init__(self, weights=None):
        super(BigEarthNetResNet50Model, self).__init__()
...
model = BigEarthNetResNet50Model()
...
output_dir = r'C:\Users\isaac\OneDrive\Documents\GitHub\Deep-Learning-Based-Land-Use-Classification-Using-Sentinel-2-Imagery\FYPProject\models\resnet50'
